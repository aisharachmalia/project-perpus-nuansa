        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-12 d-flex justify-content-start">
                              <a href="javascript:void(0)" class="btn btn-custom btn-success mb-2 modalCreate" data-bs-toggle="modal" data-bs-target="#createPinjaman">
                                + Peminjaman
                            </a>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                    <table id="tbl_peminjaman" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Judul Buku</th>
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-6 d-flex justify-content-end">
                            <a href="javascript:void(0)" class="btn btn-custom btn-danger mb-2" data-bs-toggle="modal" data-bs-target="#Pengembalian">
                                Pengembalian
                            </a>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <div class="col-12">
                        <div class="card-content">
                            <div class="card-body">
                                <div class="row">
                                    <input type="hidden" id="id_dbuku" name="id_dbuku">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="edit_nama">Judul buku</label>
                                            <input type="text" id="id_dbuku" class="form-control" placeholder="Nama Buku" name="id_dbuku">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="id_dsiswa" class="form-control" placeholder="Nama Siswa" name="id_dsiswa">
                                            <span id="siswa-error" class="text-danger"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="edit_pustakawan">Nama Pustakawan</label>
                                            <input type="text" id="id_dpustakawan" class="form-control" placeholder="Nama Pustakawan" name="id_dpustakawan">
                                            <span id="pustakawan-error" class="text-danger"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="edit_tgl_pinjam">Tanggal Peminjaman</label>
                                            <input type="date" id="trks_tgl_peminjaman" class="form-control" placeholder="tanggal pinjam" name="trks_tgl_peminjaman">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="trks_tgl_jatuh_tempo" class="form-control" placeholder="tanggal jatuh tempo" name="trks_tgl_jatuh_tempo">
...
<div class="modal fade text-left" id="createPinjaman" tabindex="-1" role="dialog" aria-labelledby="modalCreate1">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                        ...
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                <label for="city-column">Nama Pustakawan</label>
                                           <select id="siswa" name="id_dpustakawan" class="form-control">
...
<div class="modal fade" id="editPengembalian" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form-edit-pengembalian">
                @csrf <!-- CSRF Token -->
                @method('PUT') <!-- Method PUT untuk edit -->
                <div class="modal-body">
                    <div class="col-12">
                        <div class="card-content">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="edit_tgl_pengembalian">Tanggal Pengembalian</label>
                                            <input type="date" id="trks_tgl_pengembalian" class="form-control" placeholder="tanggal pengembalian" name="trks_tgl_pengembalian">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="trks_denda" class="form-control" placeholder="Denda" name="trks_denda">
                                    ...
                                    <div class="col-md-12 col-12 mt-4">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="trks_keterangan" name="trks_keterangan" rows="3"></textarea>
...
<div class="modal fade text-left" id="Pengembalian" tabindex="-1" role="dialog" aria-labelledby="modalCreate2">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form class="form" data-action="{{ route('pengembalian.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                <label for="first-name-column">Judul Buku</label>
                                <input type="text" id="id_dbuku" class="form-control" placeholder="Nama" name="id_dbuku">
                                <span id="buku-error" class="text-danger"></span>
                            </div>
                        </div>
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                <label for="last-name-column">Nama Siswa</label>
                                <input type="text" name="siswa" id="id_dsiswa" class="form-control" placeholder="Nama Siswa">
                                <span id="siswa-error" class="text-danger"></span>
                            </div>
                        </div>
                        <div class="col-md-4 col-12">
                        ...
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" placeholder="tanggal pengembalian" name="trks_tgl_pengembalian" id="trks_tgl_pengembalian">
                                <span id="tgl-pengembalian-error" class="text-danger"></span>
                            </div>
                        </div>
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="denda" name="trks_denda" id="trks_denda">
                                <span id="denda-error" class="text-danger"></span>
                            </div>
                        </div>
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                <label for="country-floating">Keterangan</label>
                                <input type="text" class="form-control" placeholder="keterangan" name="trks_keterangan" id="trks_keterangan">
                                <span id="keterangan-error" class="text-danger"></span>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        var table = $('#tbl_peminjaman').DataTable({
        serverSide: true,
        ajax: '{{ url()->current() }}',
        columns: [{
                data: 'DT_RowIndex',
...
$.ajax({
 ...
 $.ajax({
        ...
        $('body').on('click', '.modalSimpanPengembalian', function() {
            ...
            $('#tambahPengembalian').find('#tgl-pinjam-error').val();
            $('#tambahPengembalian').find('#tgl-jatuh-tempo-error').val();
            $('#tambahPengembalian').find('#tgl-pengembalian-error').val();
            $('#tambahPengembalian').find('#denda-error').val();
            $('#tambahPengembalian').find('#keterangan-error').val();
        });
        $('#simpanPengembalian').on('click', function(e) {
            e.preventDefault();
