                    ...
                    <div class="row">
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <select id="id_dsiswa" name="id_dsiswa" class="form-control rounded-pill">
                                    <option value="">Pilih Peminjam</option>
                        ...
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <select id="id_dbuku" name="id_dbuku" class="form-control rounded-pill">
                                    <option value="">Pilih Buku</option>
                                </select>
                        ...
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control rounded-pill"
                                    name="trks_tgl_peminjaman" id="trks_tgl_peminjaman">
                        ...
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control rounded-pill"
                                    name="trks_tgl_jatuh_tempo" id="trks_tgl_jatuh_tempo">
                        ...
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control rounded-pill"
                                    name="trks_tgl_pengembalian" id="trks_tgl_pengembalian">
                        ...
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control rounded-pill" name="trks_denda"
                                    id="trks_denda" placeholder="Masukkan Denda">
